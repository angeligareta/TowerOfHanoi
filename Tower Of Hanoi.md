...
![](media/1f99d1691b271936bc4b8806e3a5185d.png)

![](media/577be915f41a3e32e3d8bdeb49c9613d.png)

![](media/8d429818efd546af34552736334b3bcb.png)
...
void moveDisks(int numberOfDisks, Peg sourcePeg, Peg auxiliaryPeg, Peg
destinationPeg) {
...
moveDisks(this.numberOfDisks, this.sourcePeg, this.auxiliaryPeg,
this.destinationPeg);
...
![](media/4cb06fbce5ab9e5184eda6f239655a2c.jpg)
...
![](media/dcc6151652f2add880068d79fe160941.jpg)
...
disks the result in years would be 4166. However, it’s impossible to move the
disks manually at that speed, so we are safe!**
