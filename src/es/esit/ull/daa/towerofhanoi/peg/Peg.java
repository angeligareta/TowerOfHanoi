...
public abstract class Peg {
	 ...
	 * @param peg Type of the Structure.
	 */
	 ...
	 * @param numberOfDisks Number of disks to introduce in the peg.
	 */
	public abstract void initializePeg(int numberOfDisks);
	
	/**
	 * It draws the peg in the (x,y) coordinates received by argument.
	 * @param g Graphics to draw the Peg in.
	 * @param x X Position of the Peg.
	 * @param y Y Position of the Peg.
	 */
	 ...
	 * @param disk Element to introduce.
	 */
